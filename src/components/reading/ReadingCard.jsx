...
const ReadingCard = ({ title, excerpt, level, xpReward, onStart, isCompleted, moduleId, isBookmarked = false, onRemove = null }) => {
  const badgeColor = getDifficultyColor(level)
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full mt-4 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white text-sm font-medium py-2.5 px-4 rounded-xl transition-all shadow-sm hover:shadow-md"
      >
        {isCompleted ? 'Tekrar Oku' : 'Okumaya Başla'}
      </button>
